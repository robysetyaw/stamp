...
func TestStamp(t *testing.T) {
	...
	runTestStamp(t, "Should return []string{'1', '4', 'Foo'} when input = 6", 6, []string{"1", "4", "Foo"})
	runTestStamp(t, "Should return []string{'1','4', 'Foo',  '8', 'Foo', 'Bar', 'Foo','14', 'FooBar', '16'}) when input = 16", 16, []string{"1", "4", "Foo", "8", "Foo", "Bar", "Foo", "14", "FooBar", "16"})
}
